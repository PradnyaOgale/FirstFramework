...
import com.First_Framework.base.TestBase;
...
public class TestCases extends TestBase{
		...
		public void m2() {
			...
			waitFor.numberOfElementsToBeMoreThan(LocatorType.CSS, Locator.PRODUCTtITLE, 1);
			List<String> productTitles = kw.getTexts(Locator.PRODUCTtITLE);
		...
		/*@Test
		public void verifyErrorNotifierAfterEnteringPhoneNumber() throws InterruptedException {
		
			HomePage homepage = new HomePage();
			homepage.clickOnProfile();
			homepage.clickOnLoginSignupButton();
			homepage.enterPhoneNumber("1111111111");
