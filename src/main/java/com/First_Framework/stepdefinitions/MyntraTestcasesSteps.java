...
import com.First_Framework.pages.BlogsPage;
import com.First_Framework.pages.FaqPage;
import com.First_Framework.pages.GiftCardPage;
import com.First_Framework.pages.HomePage;
import com.First_Framework.pages.ProductPage;
import com.First_Framework.pages.SearchResultPage;
import com.First_Framework.pages.SocialMediaPage;

import io.cucumber.java.en.Given;
import io.cucumber.java.en.Then;
import io.cucumber.java.en.When;
import com.First_Framework.pages.PIPPage;

public class MyntraTestcasesSteps {

//Scenario1: Verify when user selects particular brand name then all results must appear of that brand.
...
//Scenario2: Verify when user clicks on price range checkbox then populated all results must be in selected price range	
...
//Scenario3: Verify when user selects a product then that product should have product details
...
//Scenario4: Verify when user clicks on giftcard and select an occation then giftcard must appear related to selected occasion
...
//Scenario5: Verify when user clicks on Youtube icon then it must redirect the page to youtube website.
...
//Scenario6: Verify when user clicks on instagram icon then user should be able to interact with instagram Page 
...
//Scenario7: Verify when users selects a product then that product must have appropriate size guide chart
...
//Scenario8: Verify when user checks PhonePe faqs then questions must be relevant to PhonePe
...
//Scenario9: Verify when user clicks on promotional banner then it should redirect to product results
	@Given("Open myntra")
...
//Scenario11: Verify when user cliks on a blog content then it should be interactable
...
//--------------------------------------------------------------------------------------------------------------------------------
	...
	public void the_result_display_error_message_for_invalid_input() {
		PIPPage pp = new PIPPage();
		pp.clickOnCheck();
		pp.verifyDeliveryOptionsDisplayErrorMessageForInvalidInput(
