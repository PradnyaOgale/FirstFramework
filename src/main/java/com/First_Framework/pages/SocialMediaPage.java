...
public class SocialMediaPage {
	...
	public WebElement youtubeProfileIcon;
	public void clickOnProfileIcon(){
		youtubeProfileIcon.click();
	}*/
	/*@FindBy(css = "div#items a#endpoint yt-formatted-string.title")
	public List<WebElement> youtubeTitles;
	public List<String> getTextOfYoutubeTitles() {
		Keyword keyword = new Keyword();
		return keyword.getTexts(youtubeTitles);  
	}
	//@FindBy(css = "ytd-guide-section-renderer.style-scope:nth-child(6)") 
	//@FindBy(css = "div#items a#endpoint yt-formatted-string.title") 
	public List<WebElement> pageTitle;
	public void verifyIfYoutubePageHasOpened() throws InterruptedException{
		List<String> text = getTextOfYoutubeTitles();
