...
import com.First_Framework.waits.waitFor;
...
public class SearchResultPage {
		...
		public void verifyProductTitlesContains(String expectedText){
			...
			for (String  productTitle : productTitles) {
				System.out.println("Checking1: "+productTitle);
				softly.assertTrue(productTitles.contains(expectedText));
			}
		...
		/**
		 * Below methods are related to the verification of products price whether they are between selected price range
		 * @author pradnyaogale
		 */
		...
		//@FindBy(css = "li.product-base>a[href=\"shirts/h%26m/hm-regular-fit-easy-iron-shirt/24697414/buy\"]")
		//@FindBy(css = "https://assets.myntassets.com/dpr_2,q_60,w_210,c_limit,fl_progressive/assets/images/24221860/2023/7/27/a481bb6d-b444-46db-a41c-e9d2962957ca1690442692760RegularFitOvershirt1.jpg ")
	/*	public By waitToClickProduct;
		public void waitToClickProduct() {
		...
		public void verifyAllPricesAreInLowToHighOrder() {
	        ...
	        for(int i = 1 ; i< price.size();i++ ){
	           // softly.assertTrue(price.get(i).compareTo(price.get(i+1)) <= 0,"Prices not in Low to High order.");
